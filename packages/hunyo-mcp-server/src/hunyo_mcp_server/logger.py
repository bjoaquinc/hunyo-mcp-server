"""
Hunyo MCP Server - Enhanced logging with context-aware formatting.

Provides structured logging with:
- Context-specific formatting (marimo-aware fallbacks)
...
def get_logger(name: str) -> HunyoLogger:
    ...
    Args:
        name: Logger name (e.g., 'hunyo.mcp.server')
