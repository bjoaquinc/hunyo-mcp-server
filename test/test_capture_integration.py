...
def __():
    ...
    from src.capture import get_notebook_file_hash, get_notebook_name, get_event_filenames, get_user_data_dir
    ...
    return get_notebook_file_hash, get_notebook_name, get_event_filenames, get_user_data_dir, notebook_path, runtime_file, lineage_file
...
def __():
    ...
    print(f"✅ Runtime tracker enabled with unique file naming")
    return tracker,
...
def __():
    ...
    print(f"✅ Live lineage tracking enabled with unique file naming")
    return interceptor,
...
def __():
    ...
    print(f"🔍 Checking for event files...")
